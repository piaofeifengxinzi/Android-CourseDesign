        ...
        synchronized (this) {
            ...
            if (code != ErrorInfo.MOK) {
                ...
                try {
                    ...
                    //IMG_SUFFIX为文件格式  .jpg, username为图片文件名，需要用文件名存入数据库
                    File file = new File(imgDir + File.separator + userName + IMG_SUFFIX);
                    Log.e(TAG,"Pictureuserpath==="+imgDir + File.separator + userName + IMG_SUFFIX);
